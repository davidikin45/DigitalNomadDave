...
namespace DND.Core.ViewModels
{
    public class FlightSearchClientRequestForm : BaseObjectValidatable, IMapTo<FlightSearchRequestDTO>, IHaveCustomMappings
    {
        ...
        [Required, Display(Name = "Flight Class"), EnumDatasource(Datasource = typeof(DND.Core.Enums.FlightClass))]
        ...
        [EnumDatasource(Datasource = typeof(DND.Core.Enums.SortType))]
        public string SortType { get; set; }

        [EnumDatasource(Datasource = typeof(DND.Core.Enums.SortOrder))]
