...
{
    [RoutePrefix("admin/folder-metadata")]
    public class AdminFolderMetadataController : BaseFolderMetadataControllerAuthorize
    {
        public AdminFolderMetadataController(IFileSystemRepositoryFactory fileSytemRepositoryFactory, IMapper mapper, ILogFactory logFactory, IEmailService emailService)
