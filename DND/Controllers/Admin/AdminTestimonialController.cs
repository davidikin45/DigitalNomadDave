...
{
    [RoutePrefix("admin/testimonial")]
    public class AdminTestimonialController : BaseEntityControllerAuthorize<TestimonialDTO,ITestimonialService>
    {
        public AdminTestimonialController(ITestimonialService service, IMapper mapper, ILogFactory logFactory, IEmailService emailService)
