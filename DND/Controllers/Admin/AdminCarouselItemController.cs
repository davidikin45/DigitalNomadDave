...
{
    [RoutePrefix("admin/carousel-item")]
    public class AdminCarouselItemController : BaseEntityControllerAuthorize<CarouselItemDTO, ICarouselItemService>
    {
        public AdminCarouselItemController(ICarouselItemService service, IMapper mapper, ILogFactory logFactory, IEmailService emailService)
