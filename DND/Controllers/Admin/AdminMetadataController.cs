...
{
    [RoutePrefix("admin/metadata")]
    public class AdminMetadataController : BaseJpegMetadataControllerAuthorize
    {
        public AdminMetadataController(IFileSystemRepositoryFactory fileSytemRepositoryFactory, IMapper mapper, ILogFactory logFactory, IEmailService emailService)
