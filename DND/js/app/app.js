(function () {
    ...
    window.app = angular.module('DND', ['am.multiselect', 'ngAnimate', 'ui.bootstrap', 'ui.grid', 'rzModule', 'ngCookies', 'ngMap']);

    window.app.run(['$cookies', '$http', '$rootScope', '$templateCache', 'NgMap', function ($cookies, $http, $rootScope, $templateCache, NgMap) {
