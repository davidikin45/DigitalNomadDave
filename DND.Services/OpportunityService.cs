...
{
    public class OpportunityService : BaseEntityService<IApplicationDbContext,Opportunity>, IOpportunityService
    {
        public OpportunityService(IBaseUnitOfWorkScopeFactory baseUnitOfWorkScopeFactory)
