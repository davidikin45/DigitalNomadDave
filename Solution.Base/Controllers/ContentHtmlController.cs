...
{
    public class ContentTextController : BaseController
    {
        private readonly IContentTextService Service;

        public ContentTextController(IContentTextService service, IMapper mapper, ILogFactory logFactory)
        ...
        public virtual ActionResult DetailsChild(string id)
        {
            ...
            return PartialView("_ContentText", data);
        }
