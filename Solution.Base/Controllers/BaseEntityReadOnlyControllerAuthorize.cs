...
namespace Solution.Base.Controllers
{
        ...
        where IEntityService : IBaseEntityService<TDto>
    {
        ...
        public BaseEntityReadOnlyControllerAuthorize(Boolean admin, IEntityService service, IMapper mapper = null, ILogFactory logFactory = null)
        : base(admin, service, mapper, logFactory)
        {
