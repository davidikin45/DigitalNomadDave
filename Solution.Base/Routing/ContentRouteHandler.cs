...
{
    /// <summary>
    /// Create a Generic handler which will process all the file Requests
    /// </summary>
    public class ContentRouteHandler : IRouteHandler
    {
        private IList<string> _validFolders;
        public ContentRouteHandler(IList<string> validFolders)
        {
        ...
        {
            ContentHttpHandler fileHandler = new ContentHttpHandler(_validFolders);
            return fileHandler;
        }


        private class ContentHttpHandler : BaseRangeRequestHandler
        {
            private IList<string> _validFolders;
            ...
            {
                var pathName = context.Request.RequestContext.RouteData.Values["folder"].ToString() + "/" + context.Request.RequestContext.RouteData.Values["pathName"].ToString();
                ...
                if (_physicalFilePath != "")
                {
                    ...
                    if (context.User.IsInRole("admin") || _validFolders.Where(f => pathName.StartsWith(f)).Count() > 0)
                    {
                        ...
                        else
                        {
                            ...
                            var fileName = WebHelper.ServerDetails.GetFileName(context.Request.RequestContext.RouteData.Values["pathName"].ToString());
                ...
                if (_isValidRequest)
                {
                    if (context.Request.Params["height"] != null)
                    {
                        try
                        {
                            this.height = int.Parse(context.Request.Params["height"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["width"] != null)
                    {
                        try
                        {
                            this.width = int.Parse(context.Request.Params["width"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["minheight"] != null)
                    {
                        try
                        {
                            this.minheight = int.Parse(context.Request.Params["minheight"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["minwidth"] != null)
                    {
                        try
                        {
                            this.minwidth = int.Parse(context.Request.Params["minwidth"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["maxheight"] != null)
                    {
                        try
                        {
                            this.maxheight = int.Parse(context.Request.Params["maxheight"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["maxwidth"] != null)
                    {
                        try
                        {
                            this.maxwidth = int.Parse(context.Request.Params["maxwidth"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["size"] != null)
                    {
                        try
                        {
                            this.size = int.Parse(context.Request.Params["size"]);
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["crop"] != null)
                    {
                        try
                        {
                            this.crop = (context.Request.Params["crop"] == "Y");
                        }
                        catch (Exception)
                        {
                            _isValidRequest = false;
                    ...
                    if (context.Request.Params["download"] != null)
                    {
                        try
                        {
                            this.download = true;
                    ...
                    if (context.Request.Params["watermark"] != null)
                    {
                        try
                        {
                            this.watermark = true;
            ...
            public override void CreateResponseContentIfRequired(HttpContext context)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        {
                            var converter = new VideoConverter(context.Server.GetFolderPhysicalPathById(Folders.FFMpeg));
