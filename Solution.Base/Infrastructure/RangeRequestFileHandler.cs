...
namespace Solution.Base.Infrastructure
{
    ...
    /// </summary>
    public abstract class BaseRangeRequestHandler : HttpTaskAsyncHandler
    {
        #region Constants
        ...
        private void SetCache(HttpContext context, int days)
        {
            ...
            if (days > 0)
            {
                ...
                cache.SetExpires(DateTime.Now.Add(timeSpan).Date.ToUniversalTime());
            ...
            else
            {
                ...
                context.Response.CacheControl = HttpCacheability.NoCache.ToString();
            }
        }
